...
<html>
	...
	<div class="box">
	<form method="get" action="../php/signIn.php">		
		<div class="form">
			<h2>Sign In</h2>
			<label class="input">
			<span>email</span>
            ...
            <!-- <div class="bottom"> -->
            <p class="signUp" style="font-size: 20px;"><a href="../studentLogin.php" target="_self">
				User Login</a></p>
			<p class="forgotPass"><a href="forgotPass.php" >Forgot Password ?</a></p>
            <!-- </div> -->
        </div>
